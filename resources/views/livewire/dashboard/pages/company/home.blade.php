            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <div class="sm:flex sm:space-x-5">
                    ...
                    <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                        ...
                        <p class="text-sm font-medium text-gray-600">Los Angeles, Miles st. 6</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <li>
                <div class="relative group py-4 flex items-start space-x-3">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-sm text-gray-500">I think the kids call these memes these days.</p>
                    </div>
            ...
            <li>
                <div class="relative group py-4 flex items-start space-x-3">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-sm text-gray-500">Something really expensive that will ultimately get
                            cancelled.</p>
                    </div>
                    <div class="flex-shrink-0 self-center">
                        <!-- Heroicon name: solid/chevron-right --> <x-icon name="chevron-right" class="h-5 w-5 text-gray-400 group-hover:text-gray-500" />
