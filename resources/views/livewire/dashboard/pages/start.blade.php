                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <h1 class="ml-3 text-2xl font-bold leading-7 text-gray-900 sm:leading-9 sm:truncate">Hello, {{ auth()->user()->fullname }}</h1>
                            </div>
    ...
    <div class="mt-8">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <button type="button" class="relative block w-full border-2 border-gray-300 border-dashed rounded-lg text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    <x-icon name="view-grid-add" class="mx-auto h-12 w-12 text-gray-400" />
                    <span class="mt-2 block text-sm font-medium text-gray-900"> Create a new company </span>
                </button>
