            ...
            Button::add('actions')
                ->render(function (Order $order) {
                    return Blade::render(<<<HTML
                        ...
                        @if($order->status == 1)
                            <x-button.circle warning icon="arrow-circle-right" wire:click="changeStatus('$order->uuid', 2)" />
                        @elseif($order->status == 2)
                            <x-button.circle positive icon="check" wire:click="changeStatus('$order->uuid', 3)" />
                        @endif
